...
def main():
    """Build sentiment cache for batch 2 stocks - AUTO RUN."""
    
    print("=" * 80)
    print("SENTIMENT DATABASE BUILDER - BATCH 2 (AUTO-RUN)")
    print("=" * 80)
    print(f"\nConfiguration:")
    ...
    for i, symbol in enumerate(BATCH_2_STOCKS, 1):
        ...
        temp_file = f"sentiment_batch2_progress.csv"
...
if __name__ == "__main__":
    try:
        ...
        print("\n\nINTERRUPTED BY USER")
        print("Partial results saved in sentiment_batch2_progress.csv")
